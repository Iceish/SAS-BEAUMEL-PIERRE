<header id="dashboard">
    ...
    <nav>
        ...
        <ul role="list">
            ...
            <li><a href="{{ route('dashboard.clients.index') }}"><i class="fa-solid fa-cash-register"></i>Client</a></li>
            ...
            <li><a href="{{ route('dashboard.roles.index') }}"><i class="fas fa-balance-scale-right"></i>Roles</a></li>
