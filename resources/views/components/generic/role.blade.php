<div class="generic-role">
    ...
    <div class="field head">
        ...
        <input type="checkbox" {{ $role->hasPermissionTo($category.'.list') ? "checked" : "" }} id="list_permission_{{ $category }}" value="{{ $permissions[$category.'.list']->id }}" onclick="inputCheckBox(this)"/>
    </div>
    @endif
    ...
    <div class="content">
        @if($permissions->keys()->contains($category.'.create'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.create') ? "checked" : "" }} id="create_permission_{{ $category }}" value="{{ $permissions[$category.'.create']->id }}" onclick="inputCheckBox(this)"/>
            </div>
        @endif
        ...
        @if($permissions->keys()->contains($category.'.edit'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.edit') ? "checked" : "" }} id="edit_permission_{{ $category }}" value="{{ $permissions[$category.'.edit']->id }}" onclick="inputCheckBox(this)"/>
            </div>
        @endif
        ...
        @if($permissions->keys()->contains($category.'.delete'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.delete') ? "checked" : "" }} id="delete_permission_{{ $category }}" value="{{ $permissions[$category.'.delete']->id }}" onclick="inputCheckBox(this)"/>
            </div>
        @endif
    </div>
