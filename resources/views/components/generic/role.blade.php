    ...
    <div class="content">
        @if($permissions->keys()->contains($category.'.create'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.create') ? "checked" : "" }} id="create_permission_{{ $category }}" value="{{ $permissions[$category.'.create']->id }}" onclick="Utils.bindRoleCheckbox(this)" {{ !$role->hasPermissionTo($category.'.list') ? "disabled" : "" }}/>
            </div>
        @endif
        ...
        @if($permissions->keys()->contains($category.'.edit'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.edit') ? "checked" : "" }} id="edit_permission_{{ $category }}" value="{{ $permissions[$category.'.edit']->id }}" onclick="Utils.bindRoleCheckbox(this)" {{ !$role->hasPermissionTo($category.'.list') ? "disabled" : "" }}/>
            </div>
        @endif
        ...
        @if($permissions->keys()->contains($category.'.delete'))
            <div class="field">
                ...
                <input type="checkbox" {{ $role->hasPermissionTo($category.'.delete') ? "checked" : "" }} id="delete_permission_{{ $category }}" value="{{ $permissions[$category.'.delete']->id }}" onclick="Utils.bindRoleCheckbox(this)" {{ !$role->hasPermissionTo($category.'.list') ? "disabled" : "" }}/>
            </div>
        @endif
    </div>
